...
package com.tiantianbook.okhttpdemo.zxing.decoding;
...
import com.tiantianbook.okhttpdemo.zxing.camera.PlanarYUVLuminanceSource;
...
public final class DecodeHandler extends Handler {
   ...
   * @param isFromALbum is data come from Album. 被解析的数据是否来自相册
   */
  public void decode(byte[] data, int width, int height,boolean isFromALbum) {
    long start = System.currentTimeMillis();
    Result rawResult = null;
		if (!isFromALbum) {//如果是直接扫描，图片不是来自相册
			// 竖屏
